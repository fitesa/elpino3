...
var style_IndicedeHumedad_3 = function(feature, resolution){
    ...
    if (value >= 0.152837 && value <= 0.220955) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.220955 && value <= 0.289073) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.289073 && value <= 0.357191) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.357191 && value <= 0.425309) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.425309 && value <= 0.493427) {
            style = [ new ol.style.Style({
