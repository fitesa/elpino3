...
var style_EvolucinIndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= -0.020041 && value <= 0.004462) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.004462 && value <= 0.028964) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.028964 && value <= 0.053467) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.053467 && value <= 0.077969) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.077969 && value <= 0.102472) {
            style = [ new ol.style.Style({
