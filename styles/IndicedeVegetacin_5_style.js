...
var style_IndicedeVegetacin_5 = function(feature, resolution){
    ...
    if (value >= 0.616909 && value <= 0.679519) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.679519 && value <= 0.742129) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.742129 && value <= 0.804740) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.804740 && value <= 0.867350) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.867350 && value <= 0.929961) {
            style = [ new ol.style.Style({
